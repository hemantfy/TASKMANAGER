...
const CaseDocumentModal = ({
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axiosInstance.post(
        API_PATHS.CASES.UPLOAD_DOCUMENT(caseId),
        formData,
        {
          headers: {
      ...
      console.error("Failed to upload case document:", requestError);
      const message =
  ...
  const caseLabel = caseTitle || "this case file";
  const matterLabel = matterTitle || "the linked matter";
