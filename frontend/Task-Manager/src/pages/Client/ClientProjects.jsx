...
const ClientProjects = () => {
  const viewCopy = useMemo(
    () => ({
      ...
      heroTitle: "Shared Projects",
      heroDescription:
        "Stay aligned with every deliverable your advisory team is handling.",
      filterPrompt: "Filter deliverables by status to stay aligned.",
      loadingMessage: "Loading your shared projects...",
      emptyState: "No projects found for the selected status.",
    }),
    []
  );
